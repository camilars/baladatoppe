 ...
 <head>
      ...
      <div class="container">
            ...
            <div id="baladas_cadastradas">
                  <div id="rolamento">
                        <label>
                              <div class="w3-container w3-white">
                                    <h2 style="position: absolute;top: 4%; left: 3%; color: white; text-shadow:1px 1px 0 #444 ">Baladas cadastradas:</h2>
                              </div>
                              <div class="dropdown" style="position: absolute;left:3%; top:120px;">
                              <?php
                              if (isset($_GET['id'])):
                                    $balada = $_GET['id'];
                                    $sql = "SELECT `balada` FROM `baladas` WHERE `id` ='" . $balada . "'";
                                    $result = $conn->query($sql);
                                    $res = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown"><?= $res['balada'] ?><span class="caret"></span></button>
                              <?php else: ?>
                              <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">Selecione a Balada<span class="caret"></span></button>
                              <?php endif ?>
                              ...
                              <?php
                              if (isset ($_GET['id'])) {
                              echo '<div style="background-color: #cfcfcf; width: 100%;height: 13%;padding: 1.5%;">';
                                    $balada = $_GET['id'];
            ...
            <div class="comments">
                  ...
                  <div class="comment-wrap">
                        ...
                        <h1 style="color: white;">Comentários</h1><br>
