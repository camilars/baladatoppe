    ...
    <div class="container text-center">
        <div class="form-row mt-4">
            <div class="col-sm-5 pb-3">
                ...
                <input type="text" name="usuario" class="form-control" id="exampleAccount" placeholder="nome" required>
            </div>
        </div>
        ...
        <div class="form-row mt-4">
            <div class="col-sm-5 pb-3">
                ...
                <input type="email" name="email" class="form-control" id="exampleCtrl" placeholder="exjoao123@gmail.com" required>
            </div>
        </div>
